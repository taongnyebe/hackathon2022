...
<body class="sb-nav-fixed">
  <?php require './templates/popup_add.php' ?>
                          ...
                          <table id="datatablesSimple">
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td><?php echo $drivers['m_id'] ?></td>
                                      <td>
                                        <a href="./f_update.php?id=<?php echo $drivers['m_id']?>&use=queue" class="btn btn-primary ">GO!</a>
                                      </td>
                                  </tr>
                                  <?php
                                        endforeach;
